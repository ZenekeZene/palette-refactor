...
const registerInMemory = (
  ...
  const registerPlayer: RegisterPlayer = container.resolve(
    Types.RegisterPlayer
  );
  ...
  const registerLevels: RegisterLevels = container.resolve(
    Types.RegisterLevels
  );
  ...
  const registerQuotes: RegisterQuotes = container.resolve(
    Types.RegisterQuotes
  );
